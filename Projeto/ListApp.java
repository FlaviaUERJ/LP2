                ...
                public void keyPressed (KeyEvent evt) {
                  ...
                  int keyCode = evt.getKeyCode();
					...
					if (evt.getKeyChar() == 'e') {
						...
						figs.add(new Ellipse(position.x,position.y,w,h,Color.orange,Color.blue ));
						
						} else if(evt.getKeyChar() == 'p'){
						figs.add(new Pentagono(position.x,position.y,w,h,Color.yellow,Color.red ));
						
						}else if(evt.getKeyChar() == 't'){		
						figs.add(new Triangulo(position.x,position.y,w,h,Color.blue,Color.magenta));
